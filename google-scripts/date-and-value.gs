...
function doPost(e) {
  ...
  if (parsedData !== undefined){
    ...
    //var date_now = Utilities.formatDate(new Date(), "GMT", "yyyy/MM/dd"); // gets the current date
    //var time_now = Utilities.formatDate(new Date(), "GMT", "hh:mm:ss a"); // gets the current time

    var date_now = Utilities.formatDate(new Date(), "GMT", "dd/MM/yyyy hh:mm:ss a"); // gets the current date
    // var time_now = Utilities.formatDate(new Date(), "GMT", ""); // gets the current time
